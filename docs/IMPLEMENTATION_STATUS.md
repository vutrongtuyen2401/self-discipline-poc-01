...
- **OPEN (Chờ quyết định chính thức từ Ký chủ):** **6 phân hệ** (Công thức 2/3 nhiệm vụ OPEN-01, Công thức điểm OPEN-02, Tháp Thí Luyện OPEN-03, Lược đồ DB chính thức OPEN-04, Dynamic Task Generation OPEN-05, Memory Cloud OPEN-06, Audio multimedia OPEN-07).
